...
namespace DiceBot.Controls.AnimatedFrame
{
    class AnimatedFrame : Frame
    {
        public static readonly DependencyProperty FadeDurationProperty =
            DependencyProperty.Register("FadeDuration", typeof(Duration), typeof(AnimatedFrame),
        ...
        private void FadeOutCompleted(object sender, EventArgs e)
        {
            ...
            if (_contentPresenter != null)
            {
                ...
                if (_navArgs.NavigationMode == NavigationMode.New)
                {
